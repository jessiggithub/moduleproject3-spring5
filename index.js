function moduleProject3() {
  ...
  function buildFooter(footerData) {
    ...
    contactEmailP.textContent = `Email: <a href="mailto:${footerData.contactEmail}"> ${footerData.contactEmail}</a>`
    ...
    copyrigth.textContent = `© ${footerData.companyName.toUpperCase()} ${currentYear}`
